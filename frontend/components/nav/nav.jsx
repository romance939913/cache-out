  ...
  return (
    <div className="nav-bar">
      ...
      <div className="nav-search-box">
        <NavSearch stocks={props.stocks} />
      </div>
      <div className="nav-right">
        <Link to="/feed" className="nav-right-ele">Home</Link>
        <p className="nav-right-ele" id="dark-mode" onClick={changeTheme}>Dark Mode</p>
        <a className="nav-right-ele" onClick={handleLogout}>Logout</a>
      </div>
    </div>
  );
}
